...
const Footer = () => {
  return (
    <footer className="bg-gray-200 h-screen  md:h-fit lg:h-screen flex flex-col justify-between py-5 px-[5vw] md:px-[10vw]">
      <div className='w-full flex flex-col  md:h-1/5 relative justify-between  mb-4'>
